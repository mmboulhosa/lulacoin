...
##perform gitian builds
 ...
 Build icashd and icash-qt on Linux32, Linux64, and Win32:

	./bin/gbuild --commit icash=v${VERSION} ../icash/contrib/gitian-descriptors/gitian-linux.yml
	./bin/gsign --signer $SIGNER --release ${VERSION} --destination ../gitian.sigs/ ../icash/contrib/gitian-descriptors/gitian-linux.yml
	pushd build/out
	zip -r icash-${VERSION}-linux-gitian.zip *
	mv icash-${VERSION}-linux-gitian.zip ../../../
	popd
	./bin/gbuild --commit icash=v${VERSION} ../icash/contrib/gitian-descriptors/gitian-win.yml
	./bin/gsign --signer $SIGNER --release ${VERSION}-win --destination ../gitian.sigs/ ../icash/contrib/gitian-descriptors/gitian-win.yml
	pushd build/out
	zip -r icash-${VERSION}-win-gitian.zip *
	mv icash-${VERSION}-win-gitian.zip ../../../
	popd
    ./bin/gbuild --commit icash=v${VERSION} ../icash/contrib/gitian-descriptors/gitian-osx-bitcoin.yml
