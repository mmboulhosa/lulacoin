...
##perform gitian builds
 ...
 Build lulacoind and lulacoin-qt on Linux32, Linux64, and Win32:

	./bin/gbuild --commit lulacoin=v${VERSION} ../lulacoin/contrib/gitian-descriptors/gitian-linux.yml
	./bin/gsign --signer $SIGNER --release ${VERSION} --destination ../gitian.sigs/ ../lulacoin/contrib/gitian-descriptors/gitian-linux.yml
	pushd build/out
	zip -r lulacoin-${VERSION}-linux-gitian.zip *
	mv lulacoin-${VERSION}-linux-gitian.zip ../../../
	popd
	./bin/gbuild --commit lulacoin=v${VERSION} ../lulacoin/contrib/gitian-descriptors/gitian-win.yml
	./bin/gsign --signer $SIGNER --release ${VERSION}-win --destination ../gitian.sigs/ ../lulacoin/contrib/gitian-descriptors/gitian-win.yml
	pushd build/out
	zip -r lulacoin-${VERSION}-win-gitian.zip *
	mv lulacoin-${VERSION}-win-gitian.zip ../../../
	popd
    ./bin/gbuild --commit lulacoin=v${VERSION} ../lulacoin/contrib/gitian-descriptors/gitian-osx-bitcoin.yml
