...
LulaCoin Core version 0.11.2 is now available from:

  https://lulacoinpay.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/lulacoin/lulacoin/issues


Mining and relay policy enhancements
------------------------------------

LulaCoin Core's block templates are now for version 3 blocks only, and any
mining software relying on its `getblocktemplate` must be updated in parallel
to use libblkmaker either version 0.4.2 or any version from 0.5.1 onward. If you
are solo mining, this will affect you the moment you upgrade LulaCoin Core,
...
LulaCoin Core 0.11.2 implements BIP 66, which introduces block version 3, and a
new consensus rule, which prohibits non-DER signatures. Such transactions have
been non-standard since LulaCoin 0.8, but were technically still permitted
inside blocks.
...
installer (on Windows) or just copy over /Applications/LulaCoin-Qt (on Mac) or
lulacoind/lulacoin-qt (on Linux).
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/lulacoin/).
