    ...
    fProxyIpValid(true)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("LULA-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("LULA-traditional"), QVariant("trad"));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->anonymizeLulaCoin, OptionsModel::AnonymizeLulaCoinAmount);
