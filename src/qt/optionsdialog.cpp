    ...
    fProxyIpValid(true)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ICASH-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ICASH-traditional"), QVariant("trad"));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->anonymizeiCash, OptionsModel::AnonymizeiCashAmount);
