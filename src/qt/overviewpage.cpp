...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate(): QAbstractItemDelegate(), unit(BitcoinUnits::LULA)
    {
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("LULA")
    updateDisplayUnit();
}
...
void OverviewPage::updateDarksendProgress()
{
    ...
    int64_t nMaxToAnonymize = nAnonymizeLulaCoinAmount*COIN;
